function Plot2Dand3D(FigureName, Xaxis, Xlabel, Yaxis, Ylabel, Zvalue, Zlabel, MaxZ, SelectPlot, VisibleProtectedAreas, SamplingArea)
    ...
    elseif SamplingArea == 1
        if VisibleProtectedAreas == [1, 1]
            if SelectPlot == [1, 1]
                ...
                % Plot visible area in UV-space
                Leg2 = plot3(visibleAreaX, visibleAreaY, repmat(MaxZ, 1, length(visibleAreaTheta)), 'green', 'LineWidth', 2, 'DisplayName', 'Visible Area (VA)');
                Leg3 = scatter3(FixedOutsideSamplingPointsValues(:, 1), FixedOutsideSamplingPointsValues(:, 2), ElecFieldFun(ComplexPhaseFactor, [FixedOutsideSamplingPointsValues(:, 1), FixedOutsideSamplingPointsValues(:, 2)]), 'MarkerEdgeColor', [0 0 0], 'MarkerFaceColor', [0.3 0.2 0.4], 'DisplayName', 'Outside PA Samples');
                for Counter = 1: 1 : L
                ...
                Leg3 = scatter3(FixedOutsideSamplingPointsValues(:, 1), FixedOutsideSamplingPointsValues(:, 2), ElecFieldFun(ComplexPhaseFactor, [FixedOutsideSamplingPointsValues(:, 1), FixedOutsideSamplingPointsValues(:, 2)]) / MaxZ, 'MarkerEdgeColor', [0 0 0], 'MarkerFaceColor', [0.1 0.1 0.1], 'DisplayName', 'Outside PA Samples');
                for Counter = 1 : 1 : L
