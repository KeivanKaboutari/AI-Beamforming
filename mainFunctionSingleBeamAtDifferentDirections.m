...
global Rf;
Rf = 50.000000;
save('C:\Users\k.kaboutari\Documents\MATLAB\AI-Beam MATLAB\Data\Rf.mat', 'Rf');
% Number of elements in each Rows
global M;
M = 10;
save('C:\Users\k.kaboutari\Documents\MATLAB\AI-Beam MATLAB\Data\M.mat', 'M');
% Number of elements in each Columns
global N;
N = 3;
save('C:\Users\k.kaboutari\Documents\MATLAB\AI-Beam MATLAB\Data\N.mat', 'N');
...
global L;
L = 1;
save('C:\Users\k.kaboutari\Documents\MATLAB\AI-Beam MATLAB\Data\L.mat', 'L');
...
global d;
d = 0.68;
save('C:\Users\k.kaboutari\Documents\MATLAB\AI-Beam MATLAB\Data\d.mat', 'd');
...
save('C:\Users\k.kaboutari\Documents\MATLAB\AI-Beam MATLAB\Data\Lambda.mat', 'Lambda');
k0 = 2 * pi / Lambda;
...
% [Theta, Phi] = equiDisPointsOnUpperShphericalCube();
save('C:\Users\k.kaboutari\Documents\MATLAB\AI-Beam MATLAB\Data\Theta.mat', 'Theta');
save('C:\Users\k.kaboutari\Documents\MATLAB\AI-Beam MATLAB\Data\Phi.mat', 'Phi');
...
thetaPhiPhaseWoN = zeros(angleSamplingNo, 2 + elementNo, noDesData);
% Theta, Phi, M * N Phases (with noise)
thetaPhiPhaseWN = zeros(angleSamplingNo, 2 + elementNo, noDesData);
% Theta, Phi, M * N Phases (optimized)
thetaPhiPhaseOpt = zeros(angleSamplingNo, 2 + elementNo, noDesData);
% Theta, Phi, M * N CRP
% thetaPhiPatCR = zeros(angleSamplingNo, 2 + elementNo, noDesData);
% Theta, Phi, M * N CRP (normalized)
% thetaPhiPatCRNormalized = zeros(angleSamplingNo, 2 + elementNo, noDesData);
...
% thetaPhiPatE = zeros(angleSamplingNo, 2 + elementNo, noDesData);
% Theta, Phi, M * N E-pattern (normalized)
% thetaPhiPatENormalized = zeros(angleSamplingNo, 2 + elementNo, noDesData);
% Theta, Phi, M * N E-patter (optimized)
% thetaPhiPatEOpt = zeros(angleSamplingNo, 2 + elementNo, noDesData);
% Theta, Phi, M * N E-patter (normalized and optimized)
% thetaPhiPatEOptNormalized = zeros(angleSamplingNo, 2 + elementNo, noDesData);
...
for dataSetCounter = 1 : 1 : noDesData
    ...
    Text = append('C:\Users\k.kaboutari\Documents\MATLAB\AI-Beam MATLAB\Data\dataSet', num2str(dataSetCounter), 'Noise', '.mat');
    save(Text, 'Noise');
...
%         thetaPhiPatCR(angleCounter, 3 : end, dataSetCounter) = reshape(ComplexRP, 1, elementNo);
...
%         thetaPhiPatCRNormalized(angleCounter, 3 : end, dataSetCounter) = reshape(ComplexRP ./ ComplexRPMax, 1, elementNo);
...
%         Confine = @(x) pi - rem(pi - x, 2 * pi);
        ...
        thetaPhiPhaseWoN(angleCounter, 3 : end, dataSetCounter) = reshape(ConfinedSincPatternPhaseWithoutNoise, 1, elementNo);
        % Noisy phase
...
%         NoisySincPatternPhase = SincPatternPhase + 0;
        ...
        % Save phase without noise
        thetaPhiPhaseWN(angleCounter, 3 : end, dataSetCounter) = reshape(ConfinedSincPatternPhaseNoisy, 1, elementNo);
...
%             view(2);
        ...
        if NEFieldKey == 1
            ...
            % Save E pattern
            thetaPhiPatE(angleCounter, 3 : 2 + elementNo, dataSetCounter) = reshape(AbsElectricField, 1, elementNo);
            thetaPhiPatENormalized(angleCounter, 3 : 2 + elementNo, dataSetCounter) = reshape(AbsElectricField ./ ElemBaseElectricFieldMax, 1, elementNo);
...
%                 optAbsElectricFieldSmoothedMax = max(optAbsElectricFieldSmoothed, [], 'all');
            ...
            thetaPhiPhaseOpt(angleCounter, 3 : end, dataSetCounter) = reshape(OptPhase, 1, elementNo);
            %  thetaPhiPatEOpt(angleCounter, 3 : end, dataSetCounter) = reshape(PatternE(:, :, NFE), 1, elementNo);
            %  thetaPhiPatEOptNormalized(angleCounter, 3 : end, dataSetCounter) = reshape(PatternENormalized(:, :, NFE), 1, elementNo);
...
save('C:\Users\k.kaboutari\Documents\MATLAB\AI-Beam MATLAB\Data\thetaPhiPhaseWoN.mat', 'thetaPhiPhaseWoN');
save('C:\Users\k.kaboutari\Documents\MATLAB\AI-Beam MATLAB\Data\thetaPhiPhaseWN.mat', 'thetaPhiPhaseWN');
save('C:\Users\k.kaboutari\Documents\MATLAB\AI-Beam MATLAB\Data\thetaPhiPhaseOpt.mat', 'thetaPhiPhaseOpt');

% save('C:\Users\k.kaboutari\Documents\MATLAB\AI-Beam MATLAB\Data\thetaPhiPatCR.mat', 'thetaPhiPatCR');
% save('C:\Users\k.kaboutari\Documents\MATLAB\AI-Beam MATLAB\Data\thetaPhiPatCRNormalized.mat', 'thetaPhiPatCRNormalized');
save('C:\Users\k.kaboutari\Documents\MATLAB\AI-Beam MATLAB\Data\thetaPhiPatCRSmoothed.mat', 'thetaPhiPatCRSmoothed');
save('C:\Users\k.kaboutari\Documents\MATLAB\AI-Beam MATLAB\Data\thetaPhiPatCRSmoothedNormalized.mat', 'thetaPhiPatCRSmoothedNormalized');


% save('C:\Users\k.kaboutari\Documents\MATLAB\AI-Beam MATLAB\Data\thetaPhiPatE.mat', 'thetaPhiPatE');
% save('C:\Users\k.kaboutari\Documents\MATLAB\AI-Beam MATLAB\Data\thetaPhiPatENormalized.mat', 'thetaPhiPatENormalized');
% save('C:\Users\k.kaboutari\Documents\MATLAB\AI-Beam MATLAB\Data\thetaPhiPatEOpt.mat', 'thetaPhiPatEOpt');
% save('C:\Users\k.kaboutari\Documents\MATLAB\AI-Beam MATLAB\Data\thetaPhiPatEOptNormalized.mat', 'thetaPhiPatEOptNormalized');

save('C:\Users\k.kaboutari\Documents\MATLAB\AI-Beam MATLAB\Data\thetaPhiPatESmoothed.mat', 'thetaPhiPatESmoothed');
save('C:\Users\k.kaboutari\Documents\MATLAB\AI-Beam MATLAB\Data\thetaPhiPatESmoothedNormalized.mat', 'thetaPhiPatESmoothedNormalized');
save('C:\Users\k.kaboutari\Documents\MATLAB\AI-Beam MATLAB\Data\thetaPhiPatESmoothedOpt.mat', 'thetaPhiPatESmoothedOpt');
save('C:\Users\k.kaboutari\Documents\MATLAB\AI-Beam MATLAB\Data\thetaPhiPatESmoothedOptNormalized.mat', 'thetaPhiPatESmoothedOptNormalized');

save('C:\Users\k.kaboutari\Documents\MATLAB\AI-Beam MATLAB\Data\Coeff1.mat', 'Coeff1');
save('C:\Users\k.kaboutari\Documents\MATLAB\AI-Beam MATLAB\Data\Coeff2.mat', 'Coeff2');
