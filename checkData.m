...
load('C:\Users\k.kaboutari\Desktop\Intelligent Beamforming Metasurfaces for Future Telecommunications (MATLAB Codes)\Data\One beam in (-300,0) for experimental studies\thetaPhiPhaseWoN.mat');
load('C:\Users\k.kaboutari\Desktop\Intelligent Beamforming Metasurfaces for Future Telecommunications (MATLAB Codes)\Data\One beam in (-300,0) for experimental studies\thetaPhiPhaseWN.mat');
...
load('C:\Users\k.kaboutari\Desktop\Intelligent Beamforming Metasurfaces for Future Telecommunications (MATLAB Codes)\Data\One beam in (-300,0) for experimental studies\modifiedPhaseOpt.mat');

% Load project pattern
load('C:\Users\k.kaboutari\Desktop\Intelligent Beamforming Metasurfaces for Future Telecommunications (MATLAB Codes)\Data\One beam in (-300,0) for experimental studies\thetaPhiPatCRSmoothed.mat');
load('C:\Users\k.kaboutari\Desktop\Intelligent Beamforming Metasurfaces for Future Telecommunications (MATLAB Codes)\Data\One beam in (-300,0) for experimental studies\thetaPhiPatCRSmoothedNormalized.mat');

% Load electric field (before and after optimization)
load('C:\Users\k.kaboutari\Desktop\Intelligent Beamforming Metasurfaces for Future Telecommunications (MATLAB Codes)\Data\One beam in (-300,0) for experimental studies\thetaPhiPatESmoothed.mat');
load('C:\Users\k.kaboutari\Desktop\Intelligent Beamforming Metasurfaces for Future Telecommunications (MATLAB Codes)\Data\One beam in (-300,0) for experimental studies\thetaPhiPatESmoothedNormalized.mat');
load('C:\Users\k.kaboutari\Desktop\Intelligent Beamforming Metasurfaces for Future Telecommunications (MATLAB Codes)\Data\One beam in (-300,0) for experimental studies\thetaPhiPatESmoothedOpt.mat');
load('C:\Users\k.kaboutari\Desktop\Intelligent Beamforming Metasurfaces for Future Telecommunications (MATLAB Codes)\Data\One beam in (-300,0) for experimental studies\thetaPhiPatESmoothedOptNormalized.mat');
...
save('C:\Users\k.kaboutari\Desktop\Intelligent Beamforming Metasurfaces for Future Telecommunications (MATLAB Codes)\Data\One beam in (-300,0) for experimental studies\PhaseData\PhaseWithoutNoise.mat', 'PhaseWithoutNoise');

PhaseWithNoise = [];
for DataSetCounter = 1 : 1 : DataSet
    PhaseWithNoise = [PhaseWithNoise; thetaPhiPhaseWN(:, :, DataSetCounter)];
end
save('C:\Users\k.kaboutari\Desktop\Intelligent Beamforming Metasurfaces for Future Telecommunications (MATLAB Codes)\Data\One beam in (-300,0) for experimental studies\PhaseData\PhaseWithNoise.mat', 'PhaseWithNoise');
...
save('C:\Users\k.kaboutari\Desktop\Intelligent Beamforming Metasurfaces for Future Telecommunications (MATLAB Codes)\Data\One beam in (-300,0) for experimental studies\PhaseData\PhaseOpt.mat', 'PhaseOpt');
save('C:\Users\k.kaboutari\Desktop\Intelligent Beamforming Metasurfaces for Future Telecommunications (MATLAB Codes)\Data\One beam in (-300,0) for experimental studies\PhaseData\ModifiedPhaseOpt.mat', 'ModifiedPhaseOpt');
...
ConfinedSincPatternPhaseNoisy = atan(real(optComplexPhaseFactor) ./ imag(optComplexPhaseFactor));
...
ConfinedSincPatternPhaseNoisy = atan(real(modifiedOptComplexPhaseFactor) ./ imag(modifiedOptComplexPhaseFactor));
