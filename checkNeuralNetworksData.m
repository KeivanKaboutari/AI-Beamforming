...
% load('C:\Users\k.kaboutari\Documents\MATLAB\Optimized Data\Neural Networs Data\NN_Data_1BEAM.mat');
% ComplexPhaseFactor = 1 * (reshape(transpose(reshape(NN_data(1, :), M, N)), N, M));

% Load different phases to check the directions (original date generated by algorithm)
% load('C:\Users\k.kaboutari\Documents\MATLAB\Optimized Data\Two Beams (Final)\100 Datasets\thetaPhiPhaseOpt.mat');
...
load('C:\Users\k.kaboutari\Documents\MATLAB\Optimized Data\Two Beams (Final)\100 Datasets\Combined Data\PhaseOpt.mat');
